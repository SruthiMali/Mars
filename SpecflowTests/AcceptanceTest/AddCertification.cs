    ...
    public class AddCertification
    {
        ...
        public void ThenThatCertificationShouldBeDisplayedOnMyListings()
        {
            try
            {
                ...
                Thread.Sleep(1000);
                CommonMethods.test = CommonMethods.extent.StartTest("Add an Certification");

                Thread.Sleep(1000);
                string ExpectedValue = "ISTQB";
                string ActualValue = Driver.driver.FindElement(By.XPath("//tbody/tr/td[contains(text(),'ISTQB')]")).Text;
                Thread.Sleep(500);
