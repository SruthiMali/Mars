...
{
    [Binding]
    public class AddLanguage_ScenarioOutline
    {
        ...
        public void WhenIAddANewLanguage(string p1)
        {
                ...
                //Add Language
                Driver.driver.FindElement(By.XPath("//input[@placeholder='Add Language']")).SendKeys(p1);
        ...
        public void ThenThatLanguageShouldDisplayedOnMyListings(string p0)
        {
            ...
            try
            {
                ...
                Thread.Sleep(1000);
                CommonMethods.test = CommonMethods.extent.StartTest("Add a Language with ScenarioOutline");
